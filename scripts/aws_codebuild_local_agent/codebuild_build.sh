#######################################################
# Disclaimer: Third-Party Script
#######################################################

# This script contains code that is a third-party script and is not owned or maintained by us.
# The original source code can be found at https://github.com/aws/aws-codebuild-docker-images/blob/master/local_builds/codebuild_build.sh .
# We have forked this script for our use, and any updates or changes made here may differ from the original version.
